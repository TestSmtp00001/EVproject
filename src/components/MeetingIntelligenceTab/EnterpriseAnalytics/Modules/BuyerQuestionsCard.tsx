      ...
      <div className="flex items-center mb-4 sm:mb-6 pb-3 sm:pb-4 border-b border-gray-200">
        <div className="flex items-center flex-1">
          <div className="p-2 sm:p-3 rounded-lg" style={{ backgroundColor: 'transparent' }}>
            <HelpCircle className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: '#605BFF' }} />
          </div>
          <div className="ml-3 sm:ml-4 flex-1">
            <div className="flex items-center flex-wrap">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Buyer's Questions</h3>
            ...
            <p className="text-xs sm:text-sm text-[#605BFF] font-medium">F.E.A.R.S.</p>
          </div>
        </div>
